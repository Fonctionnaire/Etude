...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Commentaire\CommentaireEtudeRepository")
 */
class CommentaireEtude
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User\User", inversedBy="commentairesEtude")
     */
    private $user;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Etude\Etude", inversedBy="commentaires")
     */
    private $etude;
